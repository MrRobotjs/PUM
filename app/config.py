...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or \
        'sqlite:///' + os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(__file__))), 'instance', 'pum.db')
    ...
    PLEX_APP_CLIENT_IDENTIFIER = "PUM-App-v1" # Example, generate a UUID for uniqueness in production if needed
